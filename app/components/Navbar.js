...
const COMPANY = "Costco Rotisserie Chicken";
const ICON_LINK = "/chicken.jpg"

const NAVBAR_NAMES_AND_LINKS = [
  {
    name: "Contact",
    href: "#" //No link
  },
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <a href="/" className="-m-1.5 p-1.5">
            ...
            <img className="h-8 w-auto" src={ICON_LINK} alt="" />
          </a>
        </div>
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          ...
          <a href={NAVBAR_NAMES_AND_LINKS[1].href} className="text-sm font-semibold leading-6 text-gray-900">
            {NAVBAR_NAMES_AND_LINKS[1].name}
          </a>
          <a href={NAVBAR_NAMES_AND_LINKS[2].href} className="text-sm font-semibold leading-6 text-gray-900">
            {NAVBAR_NAMES_AND_LINKS[2].name}
          </a>
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                ...
                <a
                  href={NAVBAR_NAMES_AND_LINKS[1].href}
                  className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50"
                >
                  {NAVBAR_NAMES_AND_LINKS[1].name}
                </a>
                <a
                  href={NAVBAR_NAMES_AND_LINKS[2].href}
                  className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50"
                >
                  {NAVBAR_NAMES_AND_LINKS[2].name}
                </a>
                <a
                  href={NAVBAR_NAMES_AND_LINKS[3].href}
                  className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50"
                >
                  {NAVBAR_NAMES_AND_LINKS[3].name}
                </a>
